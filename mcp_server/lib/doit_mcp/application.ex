defmodule DoitMcp.Application do
  ...
  def children(_env) do
    [
      ...
      # 2.11.2) — before the stdio tree so a tool call can never race its
      # start.
      DoitMcp.ImportGate.Counter,
      # The stdio tree (m03.04 item 2.11.1): anubis Session plus our own
      ...
      # (m03.04 item 2.2). nil is not infinity here (anubis falls back
