defmodule DoitMcp.CreateTaskGateTest do
  ...
  test "past the threshold the pause names the window and the batch path — no operator question" do
    ...
    # The no-stop recovery words (m03.04 item 36): the readback record, not
    # an operator confirm.
  ...
  test "a just-created initiative pauses at the normal threshold — the fresh floor is retired (m03.04 item 36.2)" do
