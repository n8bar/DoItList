...
4. Importing a mirror:
	...
	3. An unindexed target imports unnumbered; suggest a style. Unless the style is none, never put source numbers in titles, `--numbered` included: "Do dishes", never "7. Do dishes".
