...
| [ ] | M08 | Roles & Avatar | Post-launch: admin role, taskmaster (task-scoped full-control role), avatar upload. Stub. | TBD | [`milestones/m08-roles-avatar/m08-roles-avatar.md`](milestones/m08-roles-avatar/m08-roles-avatar.md) |
| [ ] | M09 | Templates & Reuse | Post-launch: reusable task trees — Initiative templates, duplicate a non-owned Initiative, trash↔duplicate interplay. Stub. | TBD | [`milestones/m09-templates-reuse/m09-templates-reuse.md`](milestones/m09-templates-reuse/m09-templates-reuse.md) |
...
| [x] | M03 | API & MCP | Programmatic API for Initiatives / Tasks / membership, designed MCP-first, plus an MCP server over it so agents can drive task trees — two lanes: MCP for chat, a scripted client for disk. | 2026-09-13 | [`milestones/m03-api-mcp/m03-api-mcp.md`](milestones/m03-api-mcp/m03-api-mcp.md) |
