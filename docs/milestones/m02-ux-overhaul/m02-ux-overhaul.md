...
1. [ ] Add the following project-specific UX rules to [`UX_GUARDRAILS.md`](../../UX_GUARDRAILS.md) § Project-Specific Additions:
...
2. [ ] Audit the M01 baseline against [`UX_GUARDRAILS.md`](../../UX_GUARDRAILS.md) § Universal Baseline; fix any gaps **not already addressed by Arc 2 items**. Use `fix/<slug>` branches per the working-style rule or roll fixes into Arc 1 commits — your call per fix.
...
- All ten Arc 2 items shipped and visible in the running app.
...
- Initiatives can be renamed and have their description edited from the right-rail panel.
